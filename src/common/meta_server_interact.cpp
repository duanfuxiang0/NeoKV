...
namespace neokv {
DEFINE_int32(meta_request_timeout, 30000, "meta as server request timeout, default:30000ms");
DEFINE_int32(meta_connect_timeout, 5000, "meta as server connect timeout, default:5000ms");
DEFINE_string(meta_server_bns, "group.opera-qa-neoMeta-000-yz.FENGCHAO.all", "meta server bns");
