...
void MetaServer::meta_manager(google::protobuf::RpcController* controller,
    ...
    if (request->op_type() == pb::OP_UPDATE_REGION
    ...
    ERROR_SET_RESPONSE(response, pb::UNSUPPORT_REQ_TYPE, "unsupported op_type in neo-redis meta", request->op_type(), log_id);
}
...
void MetaServer::neo_heartbeat(google::protobuf::RpcController* controller,
