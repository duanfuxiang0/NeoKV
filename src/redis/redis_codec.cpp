...
std::string RedisCodec::encode_key(int64_t region_id, int64_t index_id, uint16_t slot, const std::string& user_key,
...
bool RedisCodec::decode_key(const std::string& rocks_key, int64_t* region_id, int64_t* index_id, uint16_t* slot,
                            std::string* user_key, RedisTypeTag* type_tag) {
...
bool RedisCodec::decode_value(const std::string& rocks_value, int64_t* expire_at_ms, std::string* payload) {
