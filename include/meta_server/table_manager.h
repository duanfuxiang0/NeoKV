...
public:
	...
	void get_partition_info(int64_t /*table_id*/, int64_t /*partition_id*/, int64_t& partition_replica_num,
	...
	bool check_region_when_update(int64_t /*table_id*/, const std::map<int64_t, std::string>& /*min_start_key*/,
	...
	void update_startkey_regionid_map(int64_t /*table_id*/, const std::map<int64_t, std::string>& /*min_start_key*/,
	                                  const std::map<int64_t, std::string>& /*max_end_key*/,
	                                  const std::map<int64_t, std::map<std::string, int64_t>>& /*key_id_map*/) {
	}
	...
	void delete_region_ids(const std::vector<int64_t>& /*table_ids*/, const std::vector<int64_t>& /*partition_ids*/,
	...
	void erase_region(int64_t /*table_id*/, int64_t /*region_id*/, const std::string& /*start_key*/,
	...
	bool get_pk_prefix_key(int64_t /*table_id*/, const pb::PeerHeartBeat& /*peer_info*/, std::string& pk_prefix_key) {
		pk_prefix_key.clear();
		return false;
	}
	bool get_pk_prefix_key(int64_t /*table_id*/, const pb::RegionInfo& /*region_info*/, std::string& pk_prefix_key) {
		pk_prefix_key.clear();
		return false;
	}
	bool get_pk_prefix_key(int64_t /*table_id*/, int32_t /*dimension*/, const std::string& /*start_key*/,
	...
	bool is_cluster_in_fast_importer(const std::string& /*cluster*/) {
		return false;
	}

	void get_table_info(const std::set<int64_t>& table_ids, std::unordered_map<int64_t, int64_t>& table_replica_nums,
