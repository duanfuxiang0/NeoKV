...
public:
	MetaStateMachine(const braft::PeerId& peerId)
	    : CommonStateMachine(0, "meta_raft", "/meta_server", peerId), _bth(&BTHREAD_ATTR_SMALL),
	      _healthy_check_start(false), _neo_heart_beat("neo_heart_beat"), _store_heart_beat("store_heart_beat") {
