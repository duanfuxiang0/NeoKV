...
public:
	...
	static std::string encode_key(int64_t region_id, int64_t index_id, uint16_t slot, const std::string& user_key,
	...
	static bool decode_key(const std::string& rocks_key, int64_t* region_id, int64_t* index_id, uint16_t* slot,
	...
	static bool decode_value(const std::string& rocks_value, int64_t* expire_at_ms, std::string* payload);
