...
private:
	Concurrency()
	    : snapshot_load_concurrency(-FLAGS_snapshot_load_num), recieve_add_peer_concurrency(-FLAGS_snapshot_load_num),
	      add_peer_concurrency(-FLAGS_snapshot_load_num), raft_write_concurrency(-FLAGS_raft_write_concurrency),
