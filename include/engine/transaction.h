...
public:
	...
	int begin(const rocksdb::TransactionOptions& /*opt*/) {
		return 0;
	}
	...
	int get_for_update(const std::string& /*key*/, std::string* /*value*/, int /*mode*/ = 2) {
	...
	static bool fits_region_range(const rocksdb::Slice& /*key*/, const std::string& /*start_key*/,
	                              const std::string& /*end_key*/) {
		return true; // Always fits in neo-redis
	}

	// Extended version with index info
	static bool fits_region_range(const rocksdb::Slice& /*key*/, const std::string& /*value*/,
	                              const std::string* /*start_key*/, const std::string* /*end_key*/,
	                              const IndexInfo& /*pk_info*/, const IndexInfo& /*index_info*/) {
		return true; // Always fits in neo-redis
	}
