...
public:
	...
	virtual butil::Status set_term_and_votedfor(const int64_t term, const braft::PeerId& peer_id,
...
private:
	MyRaftMetaStorage(int64_t region_id, RocksWrapper* db, rocksdb::ColumnFamilyHandle* handle);
	int load();
	int save();
